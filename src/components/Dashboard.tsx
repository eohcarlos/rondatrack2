          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center gap-3 lg:gap-4">
              ...
              <div className="flex flex-col">
                <h1 className="text-lg font-bold bg-gradient-to-r from-primary via-primary to-accent bg-clip-text text-transparent lg:text-xl text-left py-0 my-0 mx-0 px-0">RondaTrack</h1>
                {companyName && <p className="text-xs text-muted-foreground font-medium px-0">{companyName}</p>}
              </div>
            </div>
